...
process.load("electrons/ProducerTest/ProducerTestSequence_cff")

# NEEDED FOR ANYTHING PRIOR TO reMiniAOD
#process.weightsCount.pileupInfo = "addPileupInfo"

from electrons.ProducerTest.ProducerTestOutputCommands_cff import microAODDefaultOutputCommand
...
process.p = cms.Path(process.ProducerTestSequence)
...
from electrons.ProducerTest.ProducerTestCustomize import customize
customize(process)
